...
#Publish-Project -ProjectName "RTLSDR.Common" -PackageVersion "1.0.4" -PSScriptRoot $PSScriptRoot -Token $token
...
Publish-Project -ProjectName "RTLSDR.DAB" -PackageVersion "1.0.6" -PSScriptRoot $PSScriptRoot -Token $token
